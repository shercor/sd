...
type Solicitud struct {
	...
	PORT int32  `protobuf:"varint,2,opt,name=PORT,proto3" json:"PORT,omitempty"` // puerto jugador
}
...
func (x *Solicitud) GetPORT() int32 {
	if x != nil {
		return x.PORT
	}
	return 0
...
var file_my_proto_proto_rawDesc = []byte{
	...
	0x50, 0x12, 0x12, 0x0a, 0x04, 0x50, 0x4f, 0x52, 0x54, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52,
